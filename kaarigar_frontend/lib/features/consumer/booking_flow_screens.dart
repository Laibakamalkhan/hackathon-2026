        ...
        child: SafeArea(
          child: ListView(
            ...
            children: [
                  ...
                  Expanded(
                    child: GlassCard(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('3 best providers mile hain! 🏆', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16)),
              ...
              ...List.generate(MockDataService.providers.length, (i) {
      ...
      body: DecorativeBackground(
        child: ListView(
          ...
          children: [
            ...
            GradientCtaButton(label: 'Booking Confirm Karein — PKR $total', onPressed: () => context.go(AppRoutes.bookingConfirmed)),
            const SizedBox(height: 12),
            OutlinedButton.icon(
                ...
                GlassCard(
                  child: Column(
                    children: [
                      ...
                      _detailRow('Total', 'PKR 880', highlight: true),
                      _detailRow('Booking ID', '#BSK-2024-1821'),
